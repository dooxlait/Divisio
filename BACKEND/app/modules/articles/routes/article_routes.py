    ...
    try:
        ...
        return success_response({
            ...
            "détail": {
                ...
                "condtionnement_chaud": resultats["count_conditionnement"],
                "relation": resultats["count_relation"],
                "caracteristiques": resultats["count_caracteristique"]
            }
        })
    except Exception as e:
...
@article_bp.route("/filter-by-caracteristique", methods=["GET"])
def filter_articles_by_caracteristique():
    try:
