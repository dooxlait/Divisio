...
def register_production_routes(app, url_prefix="/production"):
    from .routes import production_order_routes, production_recipe_bp, ingredient_recette_bp
    app.register_blueprint(production_recipe_bp, url_prefix=f"{url_prefix}/recipes")
    app.register_blueprint(ingredient_recette_bp, url_prefix=f"{url_prefix}/ingredients")
